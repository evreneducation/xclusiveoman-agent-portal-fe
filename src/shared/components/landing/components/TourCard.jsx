...
// title, description). The media block is a gradient placeholder (see
// data.js) standing in for real per-tour photography.
import { FiClock } from 'react-icons/fi';

export function TourCard({ title, description, duration, gradient }) {
  return (
